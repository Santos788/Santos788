...
<p align="center">
  <em>Estudante de Cybersegurança · Foco em Linux, Redes, Python e Segurança Ofensiva · Em busca de oportunidade</em><br/>
  <em>Cybersecurity Student · Focused on Linux, Networking, Python & Offensive Security · Open to opportunities</em>
</p>
...
const clayton = {
  ...
  english    : "Beginner & actively improving 📈",

  currentGoal : "Land my first Cybersecurity opportunity",
  motto       : "Learn. Build. Break. Fix. Repeat.",

  approach : "Learning by doing — build labs, break things on purpose, understand the failure, fix it, document it"
};
```
...
> **Estou em busca da minha primeira oportunidade em Cybersegurança**, onde possa aplicar meus conhecimentos em Linux, redes, Python e segurança ofensiva, contribuir com problemas reais e crescer junto a um time que valorize aprendizado contínuo.
>
> **I'm looking for my first opportunity in Cybersecurity**, where I can apply my knowledge of Linux, networking, Python and offensive security, contribute to real problems, and grow within a team that values continuous learning.
...
<tr>
<td align="center" colspan="2"><strong>⚙️ Backend & Scripting</strong></td>
</tr>
<tr>
<td>
...
<tr>
<td align="center" colspan="2"><strong>📊 Dados / Data</strong></td>
</tr>
<tr>
<td>
...
<tr>
<td align="center" colspan="2"><strong>🔐 Security Tools & DevOps</strong></td>
</tr>
<tr>
<td>
...
<tr>
<td align="center" colspan="2"><strong>🌱 Aprendendo / Currently Learning</strong></td>
</tr>
<tr>
<td>
...
## 🚀 Projetos & CTFs em Destaque / Featured Projects & CTFs

> **🛠️ [HybridOS V2](https://github.com/Santos788/hybrid-os)**
>
> **`Bash`**
>
...
> *Repository constantly updated as new CTFs and tools are developed.*
...
## 🎖️ Certificações & Cursos / Certifications
...
| 💡 | Habilidade / Skill | Contexto / Context |
|:---:|:---|:---|
| 🔍 | **Pensamento analítico / Analytical thinking** | Enumeração e análise de vulnerabilidades passo a passo |
| 📋 | **Documentação / Documentation** | Registro detalhado de writeups e progresso de estudo |
| 🎯 | **Foco em solução / Solution-oriented** | "Entender a falha antes de corrigir" |
| 🛠️ | **Curiosidade técnica / Technical curiosity** | Gosto de entender *como os sistemas quebram por dentro* |
| 📈 | **Aprendizado autônomo / Self-directed learning** | Estudo diário via labs práticos e CTFs |
...
- [x] Aprofundar Linux
- [x] Dominar Python para Segurança
